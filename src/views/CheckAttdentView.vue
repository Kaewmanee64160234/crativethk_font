...
const students = [
  {
    ...
    status: "มาเรียน",
    image1:
      "https://plus.unsplash.com/premium_photo-1671718111036-0a4b73625a4a?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    image2:
      "https://images.unsplash.com/photo-1712847333437-f9386beb83e4?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxzZWFyY2h8MXx8aHVtYW58ZW58MHx8MHx8fDA%3D",
    description: " 98% Matching",
  },
  {
    id: "64160048",
    name: "Jane Doe",
    ...
    image2:
      "https://plus.unsplash.com/premium_photo-1671656333460-793292581bc6?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    description: "20% Matching",
  },
];
const items = ["มาเรียน", "ไม่มาเรียน"];
const selected = ["มาเรียน"];
