      ...
      <v-card class="mx-auto" style="width: 70vw; padding: 30px">
        ...
        <v-row>
          ...
          <v-col cols="12" md="4" class="d-flex justify-center align-center">
            <v-avatar size="192">
              <img
                :src="userStore.currentUser!.images ? userStore.currentUser!.images[0] : 'path_to_default_image'"
                @error="onImageError"
                alt="User Profile"
              />
            </v-avatar>
